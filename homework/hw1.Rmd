...
**Your answer:** No. the size of the folder is 8B, while the size of the individule files add up to 3.9M. That's because "the size of the folder" is really the size of the meta information of the folder.
...
https://github.com/Mavis-Liang/hiper-logit-demo.git
